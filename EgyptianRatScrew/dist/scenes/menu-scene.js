...
export class MenuScene extends Phaser.Scene {
    ...
    createInstructions() {
        ...
        const panel = this.add.rectangle(this.cameras.main.centerX, this.cameras.main.centerY, 700, 600, 0x1a1a1a);
        panel.setStrokeStyle(3, 0xffd700);
        const title = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY - 270, 'HOW TO PLAY EGYPTIAN RATSCREW', {
            fontSize: '28px',
            color: COLORS.GOLD,
            fontStyle: 'bold'
        }).setOrigin(0.5);
        ...
        instructions.forEach((line) => {
            ...
            const instructionText = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY + yOffset, line, {
                fontSize,
                color,
                fontStyle
            }).setOrigin(0.5);
    ...
    setupInput() {
        ...
        this.input.on('pointerdown', (pointer) => {
            if (this.instructionsVisible) {
                const panelBounds = new Phaser.Geom.Rectangle(this.cameras.main.centerX - 350, this.cameras.main.centerY - 300, 700, 600);
